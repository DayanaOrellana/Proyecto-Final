...
{
    internal class _4x4: VehivuloBase
    {
    ...
    public void Pasajeros()
        {
            Console.WriteLine("El automovil esta destinado para 8 pasajeros");
        }

        public void Seguridad()
        {
            Console.WriteLine("Tiene mucho menos riesgo de sufrir accidentes");
        }

        public void Aceleracion()
        {
            Console.WriteLine("Acelerar mas facilmente y en un menor tiempo ");
        }
        //metodo
        public void Motor()
        {
            Console.WriteLine("Cuenta con un motor muy potente");
        }
