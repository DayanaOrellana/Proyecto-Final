...
{
    internal class Automovil : VehivuloBase
    {
        ...
        {
            Console.WriteLine("El automovil esta destinado para 5 pasajeros");
        }

        public void Seguridad()
        {
            Console.WriteLine("Mucha seguridad en caso de accidentes");
        }

        public void Combustible()
        {
            Console.WriteLine("Ahorro de Combustible ");
        }
        //metodo
        public void motor()
        {
